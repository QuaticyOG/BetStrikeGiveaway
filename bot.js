...
async function registerCommands() {
    const commands = [
        new SlashCommandBuilder().setName("stopgiveaways").setDescription("Stop the giveaways"),
        new SlashCommandBuilder().setName("startgiveaways").setDescription("Start the giveaways"),
        new SlashCommandBuilder()
            .setName("setgiveawaychannel")
            .setDescription("Set the channel for winners")
...
client.on("interactionCreate", async interaction => {
    ...
    if (commandName === "startgiveaways") {
        if (client.giveawaysRunning) return interaction.reply("Giveaways already running!");
        client.giveawaysRunning = true;
